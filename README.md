Google Glass Hello World App 
===========
This is a simple Hello World app to evaluate how Google Glass development is done.

## Goals
To evaluate Google Glass development.

## Requirements
* Google Glass wearable, Android Studio with Google Glass API
